  ...
  render() {
    return (
     <div className="xychty"> 
        <img src={require('../imgs/charlie.jpg')} alt="" onClick={this.playAndilci}/>
        <img src={require('../imgs/charlie2.jpg')} alt=""  onClick={this.playChlastat}/>
        <img src={require('../imgs/charlie3.jfif')} alt="" onClick={this.playRozumim}/>
        <img src={require('../imgs/alan.jpg')} alt="" onClick={this.playHlava}/>
        <img src={require('../imgs/alan2.jpg')} alt="" onClick={this.playProktolog}/>
        <img src={require('../imgs/alan3.jpg')} alt="" onClick={this.playTekutiny}/>
        <img src={require('../imgs/Berta.jpg')} alt="" onClick={this.playKondom}/>
        <img src={require('../imgs/berta2.jpg')} alt="" onClick={this.playOpera}/>
        <img src={require('../imgs/berta3.jpg')} alt="" onClick={this.playVysavac}/>
        <img src={require('../imgs/jake.jpg')} alt="" onClick={this.playUkol}/>
        <img src={require('../imgs/evelyn.jpg')} alt="" onClick={this.playCigaretka}/>
        <img src={require('../imgs/herb.jpg')} alt="" onClick={this.playHerb}/> 
     </div>
    )
  }
}
